...
'kubejs:attack_dodge' || 'kubejs:creative_flight' || 'kubejs:extreme_fitness' || 'kubejs:extreme_strength' || 'kubejs:flying_speed' || 'kubejs:magic_capacity' || 'kubejs:dragon_blood' || 'kubejs:charming' || 'kubejs:knockback' || 'kubejs:crit_chance' || 'kubejs:crit_damage' || 'kubejs:magic_overload' || 'kubejs:ice_spell_power' || 'kubejs:fire_spell_power' || 'kubejs:immunosuppression'
