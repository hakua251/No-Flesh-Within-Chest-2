...
function GetGulaChallengeTargetDish(round) {
    switch (round) {
        ...
        case 6:
            return RandomGet(['kubejs:human_meat_sausage'])
        default:
