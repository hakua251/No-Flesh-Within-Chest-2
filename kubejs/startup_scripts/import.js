...
const $WaveModifier = Java.loadClass('dev.shadowsoffire.gateways.gate.WaveModifier')
const $Failure = Java.loadClass('dev.shadowsoffire.gateways.gate.Failure')
const $GateRules = Java.loadClass('dev.shadowsoffire.gateways.gate.GateRules')
const $Reward = Java.loadClass('dev.shadowsoffire.gateways.gate.Reward')
const $SpawnAlgorithms = Java.loadClass('dev.shadowsoffire.gateways.gate.SpawnAlgorithms')
const $BossEventSettings = Java.loadClass('dev.shadowsoffire.gateways.gate.BossEventSettings')
const $NormalGatewayEntity = Java.loadClass('dev.shadowsoffire.gateways.gate.normal.NormalGateway')
const $EndlessGateway = Java.loadClass('dev.shadowsoffire.gateways.gate.endless.EndlessGateway')
