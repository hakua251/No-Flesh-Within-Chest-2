...
StartupEvents.registry('item', event => {
    ...
    event.create('kubejs:golem_cable').maxStackSize(1).tag('kubejs:machine').tag('kubejs:basic').texture('kubejs:item/organs/machine/golem_cable').tag('kubejs:spine').tag('kubejs:muscle')
