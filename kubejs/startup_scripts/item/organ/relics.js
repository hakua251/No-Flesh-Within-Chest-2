...
StartupEvents.registry('item', event => {
    ...
    event.create('kubejs:harbinger_lung').maxDamage(30).maxStackSize(1).texture('kubejs:item/organs/relics/harbinger_lung').tag('kubejs:relics').tag('kubejs:nether').tag('kubejs:lung')
})