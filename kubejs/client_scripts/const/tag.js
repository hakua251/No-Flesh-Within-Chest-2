...
const OrganTagMap = {
    ...
    'kubejs:player_spell_cast_only': Text.gold(Text.translatable('tooltips.kubejs.tag.kubejs:player_spell_cast_only')),
    'kubejs:player_spell_cast': Text.gold(Text.translatable('tooltips.kubejs.tag.kubejs:player_spell_cast')),
