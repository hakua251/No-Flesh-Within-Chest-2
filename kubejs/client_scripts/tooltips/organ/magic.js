...
RegistryOrganTooltip(new MultiStateTooltip('kubejs:potion_skin')
    ...
    .addAlt(Text.translatable('tooltips.kubejs.potion_skin.alt.2', Text.gold('5'), MagicOverloadHover, Text.gold('1')))
)
...
RegistryOrganTooltip(new MultiStateTooltip('kubejs:necromancer_skull')
    .addDefault(Text.translatable('tooltips.kubejs.necromancer_skull.default.1').gray())
    .addAlt(Text.translatable('tooltips.kubejs.necromancer_skull.alt.1'))
    .addAlt(Text.translatable('tooltips.kubejs.necromancer_skull.alt.2', Text.gold('1'), MagicOverloadHover, Text.gold('1')))
)

RegistryOrganTooltip(new MultiStateTooltip('kubejs:frost_eyeball')
    .addDefault(Text.translatable('tooltips.kubejs.frost_eyeball.default.1').gray())
    .addAlt(Text.translatable('tooltips.kubejs.frost_eyeball.alt.1'))
    .addAlt(Text.translatable('tooltips.kubejs.frost_eyeball.alt.2', Text.gold('1'), MagicOverloadHover, Text.gold('2')))
)

RegistryOrganTooltip(new MultiStateTooltip('kubejs:blazing_eyeball')
    .addDefault(Text.translatable('tooltips.kubejs.blazing_eyeball.default.1').gray())
    .addAlt(Text.translatable('tooltips.kubejs.blazing_eyeball.alt.1'))
    .addAlt(Text.translatable('tooltips.kubejs.blazing_eyeball.alt.2', Text.gold('1'), MagicOverloadHover, Text.gold('2')))
)

RegistryOrganTooltip(new MultiStateTooltip('kubejs:sacred_heart')
    .addDefault(Text.translatable('tooltips.kubejs.sacred_heart.default.1').gray())
