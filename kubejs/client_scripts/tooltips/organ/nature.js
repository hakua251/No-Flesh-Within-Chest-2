// priority: 900
RegisteryOrganTooltip(new MultiStateTooltip('kubejs:sea_bunny_skin')
...
RegisteryOrganTooltip(new MultiStateTooltip('kubejs:mammary_gland')
...
RegisteryOrganTooltip(new MultiStateTooltip('kubejs:moew_nose')
...
RegisteryOrganTooltip(new MultiStateTooltip('kubejs:tentacles_harvester')
...
RegisteryOrganTooltip(new MultiStateTooltip('kubejs:leaf_insect_exoskeleton')
...
RegisteryOrganTooltip(new MultiStateTooltip('crittersandcompanions:dragonfly_wing')
    .addDefault(Text.translatable('tooltips.crittersandcompanions.dragonfly_wing.default.1').gray())
)

RegisteryOrganTooltip(new MultiStateTooltip('kubejs:koi_fish_scale')
...
RegisteryOrganTooltip(new MultiStateTooltip('kubejs:otter_tooth')
...
RegisteryOrganTooltip(new MultiStateTooltip('kubejs:red_panda_tail')
...
RegisteryOrganTooltip(new MultiStateTooltip('kubejs:pelican_larynx')
...
RegisteryOrganTooltip(new MultiStateTooltip('kubejs:owl_vertebrae')
...
RegisteryOrganTooltip(new MultiStateTooltip('kubejs:bison_horn')
...
RegisteryOrganTooltip(new MultiStateTooltip('kubejs:hedgehog_thorn')
...
RegisteryOrganTooltip(new MultiStateTooltip('kubejs:cassowary_muscle')
...
RegisteryOrganTooltip(new MultiStateTooltip('kubejs:leech_mouthpart')
