...
RegistryOrganTooltip(new MultiStateTooltip('kubejs:explosion_bag')
    ...
    .addAlt(Text.translatable('tooltips.kubejs.explosion_bag.alt.2'))
)
...
RegistryOrganTooltip(new MultiStateTooltip('kubejs:fox_tail')
    ...
    .addAlt(Text.translatable('tooltips.kubejs.fox_tail.alt.1'))
...
RegistryOrganTooltip(new MultiStateTooltip('kubejs:frog_tongue')
    ...
    .addAlt(Text.translatable('tooltips.kubejs.frog_tongue.alt.1'))
...
RegistryOrganTooltip(new MultiStateTooltip('kubejs:witch_stomach')
    ...
    .addAlt(Text.translatable('tooltips.kubejs.witch_stomach.alt.1'))
)