// priority: 900
RegisteryOrganTooltip(new MultiStateTooltip('kubejs:rose_quartz_muscle')
...
RegisteryOrganTooltip(new MultiStateTooltip('kubejs:rose_quartz_heart')
    .addDefault(Text.translatable('tooltips.kubejs.rose_quartz_heart.default.1').gray())
    .addAlt(Text.translatable('tooltips.kubejs.rose_quartz_heart.alt.1', Text.gold('1'), Text.gold('1')))
    .addCtrl(RosyExplosionSlotType)
    .addCtrl(Text.translatable('tooltips.kubejs.rose_quartz_heart.ctrl.1'))
    .addCtrl(Text.translatable('tooltips.kubejs.rose_quartz_heart.ctrl.2', Text.gold('1'), Text.gold('1')))
)

RegisteryOrganTooltip(new MultiStateTooltip('kubejs:rose_quartz_rib')
...
RegisteryOrganTooltip(new MultiStateTooltip('kubejs:rose_quartz_dialyzer')
    .addDefault(Text.translatable('tooltips.kubejs.rose_quartz_dialyzer.default.1').gray())
    .addAlt(Text.translatable('tooltips.kubejs.rose_quartz_dialyzer.alt.1'))
    .addAlt(Text.translatable('tooltips.kubejs.rose_quartz_dialyzer.alt.2', Text.gold('1'), Text.gold('5')))
    .addCtrl(RosyExplosionSlotType)
    .addCtrl(Text.translatable('tooltips.kubejs.rose_quartz_dialyzer.ctrl.1'))
    .addCtrl(Text.translatable('tooltips.kubejs.rose_quartz_dialyzer.ctrl.2', Text.gold('1'), Text.gold('5')))
)
