...
uniform float hideRed;
uniform float hideOrange;
uniform float hideBrown;
uniform float hideYellow;
uniform float hideGreen;
uniform float hideLime;
uniform float hideCyan;
uniform float hideLightBlue;
uniform float hideBlue;
uniform float hideMagenta;
uniform float hidePurple;
uniform float hidePink;
